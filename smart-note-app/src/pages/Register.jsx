...
export default function Register() {
  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, (u) => {
      if (u && !registerInProgress) navigate('/')
    })
    return () => unsub()
  }, [navigate, registerInProgress])
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setNotice({ type: 'success', message: 'Registration successful.' })
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md">
        <div className="mb-6 text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">Join Smart Note App in seconds</p>
        </div>
